...
# phonemizer = EspeakBackend(language='en-us', preserve_punctuation=True, with_stress=True, espeak_command='C:\\Program Files (x86)\\eSpeak\\command_line\\espeak.exe')
...
# nltk.data.path.append(r'C:\Users\gitan\AppData\Roaming\nltk_data')
...
if __name__ == "__main__":
    ...
    ref_style = synthesizer.compute_style('Models/LibriTTS/gitansh.wav')

    # Generate speech
    audio = synthesizer.inference(
        text="kya re gaandu, chal nikal yaha se",
        ref_s=ref_style,
    )
