...
def main(config_path):
    ...
    print(f"Training data from {train_path}")
    print(f"Validation data from {val_path}")
    print(f"Root path from {root_path}")
    ...
    print("\n Starting training...\n")
    print(f"Epochs: {epochs}, Batch size: {batch_size}, Max training length: {max_len} frames")
    ...
    for epoch in range(start_epoch, epochs):
        ...
        train_iter = tqdm.tqdm(enumerate(train_dataloader), total=len(train_dataloader), bar_format='{l_bar}{bar:30}{r_bar}')
